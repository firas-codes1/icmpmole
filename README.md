...
2. Encode Protocols to the following values: 1 for ICMP and TCP, and 0 for all others. TCP was intentionally grouped with ICMP to allow for imorovement in future work including TCP flood detection.
